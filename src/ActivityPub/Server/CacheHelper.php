...
use ActivityPub\Server\Configuration\CacheConfiguration;
use Exception;

/**
 * \ActivityPub\Server\CacheHelper provides global helper methods for 
 * cache manipulation.
 */
abstract class CacheHelper
{
     ...
     * Inject a cache pool
     * 
     * @param  \ActivityPub\Server\Configuration\CacheConfiguration $config
     */
